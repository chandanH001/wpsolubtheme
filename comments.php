    ...
    <?php
        ...
        $fields = array(
            ...
            'email' => '<div class="col-xl-6"><div class="postbox-details-input-box"><div class="postbox-details-input mb-20">
               <input type="email" name="email" id="email" placeholder="' . esc_attr__('Email', 'solub') . '" value="' . esc_attr($commenter['comment_author_email']) . '" ' . ($req ? 'required' : '') . '>
         </div></div></div>',
            'url' => '<div class="col-xl-12"><div class="postbox-details-input-box"><div class="postbox-details-input mb-20"><input type="text" name="url" id="url" placeholder="' . esc_attr__('Website', 'solub') . '" value="' . esc_attr($commenter['comment_author_url']) . '">
         </div></div></div></div>',
        );
        ...
        $defaults = [
            ...
            'submit_button' => '<div class="col-12"> <div class="postbox-details-input-box">
                                    <button type="submit" class="tp-btn btn-text-flip d-inline-block">
                                        <span data-text="' . esc_html__('Post Comment', 'solub') . '">' . esc_html__('Post Comment', 'solub') . '</span>
                                    </button>
                                </div></div>',
